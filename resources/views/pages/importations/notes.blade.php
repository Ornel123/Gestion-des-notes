                                        ...
                                        <fieldset class="row mb-3">
                                            ...
                                            <div class="row col-sm-7">
                                                <div class="col-md-3 form-check">
                                                    <input class="form-check-input" type="radio" name="type_note" id="cc" value="cc" checked="">
                                                    <label class="form-check-label" for="cc">
                                                        CC
                                                    </label>
                                                </div>
                                                <div class="col-md-3 form-check">
                                                    <input class="form-check-input" type="radio" name="type_note" id="tp" value="tp">
                                                    <label class="form-check-label" for="tp">
                                                        TP
                                                    </label>
                                                </div>
                                                <div class="col-md-3 form-check disabled">
                                                    <input class="form-check-input" type="radio" name="type_note" id="sn" value="sn">
